    ...
    return (
        <>
            <div className="min-h-screen bg-gradient-to-br from-obsidian to-arsenic text-isabelline relative overflow-hidden">
                ...
                <Header
                    logout={logout}
                    toggleSignInModal={() => setSignInModalOpen((prev) => !prev)}
                    toggleSignUpModal={() => setSignUpModalOpen((prev) => !prev)}
                />
            ...
            {signInModalOpen && (
                <Modal isOpen={() => setSignInModalOpen(true)} onClose={() => setSignInModalOpen(false)}>
